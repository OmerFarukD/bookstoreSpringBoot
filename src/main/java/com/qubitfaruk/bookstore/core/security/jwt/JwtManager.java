...
import com.qubitfaruk.bookstore.core.security.SecurityUtils;
...
@Component
public class JwtManager implements IJwtProvider{
    ...
    private Claims extractClaims(HttpServletRequest request){
        String token= SecurityUtils.extracthAuthTokenFromRequest(request);
        if (token==null){
            return null;
        }
        return Jwts.parser()
